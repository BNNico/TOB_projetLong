...
public class NewMenuPrincipal {
    ...
    public static Rectangle playButton = new Rectangle(NewMenuPrincipal.WIDTH / 2 - 70, 350, 140, 50);
    public static Rectangle helpButton = new Rectangle(NewMenuPrincipal.WIDTH / 2 - 70, 450, 140, 50);
    public static Rectangle quitButton = new Rectangle(NewMenuPrincipal.WIDTH / 2 - 70, 550, 140, 50);
    public static Rectangle SaveButton = new Rectangle(NewMenuPrincipal.WIDTH / 2 - 80, 650, 180, 50);
    public static Rectangle boutonPasser = new Rectangle(NewMenuPrincipal.WIDTH / 2 - 70, 665, 130, 50);
    ...
    Graphics graph;
    public static  JFrame frame = new JFrame("Menu 7elda");
    ...
    public void render() throws IOException, InterruptedException {
        ...
        while (State == STATE.MENU) {
            ...
            if (mx >= NewMenuPrincipal.playButton.getMinX() && mx <= NewMenuPrincipal.playButton.getMaxX()) {
                if (my >= NewMenuPrincipal.playButton.getMinY() + NewMenuPrincipal.playButton.getHeight()/2 && my <= NewMenuPrincipal.playButton.getMaxY() + NewMenuPrincipal.playButton.getHeight()/2 ) {
            ...
            if (mx >= NewMenuPrincipal.helpButton.getMinX()&& mx <= NewMenuPrincipal.helpButton.getMaxX()) {
                if (my >= NewMenuPrincipal.helpButton.getMinY() + NewMenuPrincipal.helpButton.getHeight()/2 && my <= NewMenuPrincipal.helpButton.getMaxY() + NewMenuPrincipal.helpButton.getHeight()/2) {
            ...
            if (mx >= NewMenuPrincipal.quitButton.getMinX()&& mx <= NewMenuPrincipal.quitButton.getMaxX()) {
                if (my >= NewMenuPrincipal.quitButton.getMinY() + NewMenuPrincipal.quitButton.getHeight()/2 && my <= NewMenuPrincipal.quitButton.getMaxY() + NewMenuPrincipal.quitButton.getHeight()/2) {
            ...
            if (mx >= NewMenuPrincipal.SaveButton.getMinX() && mx <= NewMenuPrincipal.SaveButton.getMaxX()) {
                if (my >= NewMenuPrincipal.SaveButton.getMinY() + NewMenuPrincipal.SaveButton.getHeight()/2 && my <= NewMenuPrincipal.SaveButton.getMaxY() + NewMenuPrincipal.SaveButton.getHeight()/2) {
                    NewMenuPrincipal.buttonEntered = NewMenuPrincipal.BUTTON_ENTERED.SAUVEGARDE;
                }
            }
        }

        /** Lancement du Menu Sauvegarde */
        if (State == STATE.SAUVEGARDE) {
            new MenuSauvegarde();
        }
